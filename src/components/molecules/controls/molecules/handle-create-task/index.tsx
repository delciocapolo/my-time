    ...
    return (
        <Fragment>
            <Button 
                ...
                variant={"default"} 
                className="
                    border-gray-300 dark:border-gray-600 bg-background dark:bg-background text-foreground 
                    rounded-none rounded-r-sm hover:bg-gray-500/15 
                    @max-xs:w-full @max-xs:rounded-b-sm
                "
